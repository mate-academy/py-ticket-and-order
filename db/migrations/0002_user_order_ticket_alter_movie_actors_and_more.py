# Generated by Django 4.0.2 on 2025-01-14 18:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='movie',
            index=models.Index(fields=['title'], name='title_indexing'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='movie_session',
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('seat', 'row', 'movie_session'), name='unique_row_seat'),
        ),
    ]
