# Generated by Django 4.0.2 on 2024-11-25 19:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='movie',
            index=models.Index(fields=['title'], name='customer_title_idx'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='movie_session',
        ...
        migrations.AddConstraint(
            model_name='ticket',
            constraint=models.UniqueConstraint(fields=('row', 'seat', 'movie_session'), name='unique_fields'),
        ),
    ]
