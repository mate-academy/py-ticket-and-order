# Generated by Django 4.0.2 on 2025-02-18 07:14
...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'},
                                              help_text='Required. 150 characters or fewer. Letters, digits '
                                                        'and @/./+/-/_ only.', max_length=150, unique=True,
        ...
        migrations.AlterField(
            ...
            name='cinema_hall',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='movie_sessions',
                                    to='db.cinemahall'),
        ),
        migrations.AlterField(
            model_name='moviesession',
