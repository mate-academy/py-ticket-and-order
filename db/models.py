...
class Ticket(models.Model):
    ...
    def __str__(self) -> str:
        movie_session_info = self.movie_session
        movie_session_date = movie_session_info.show_time.strftime(
            "%Y-%m-%d %H:%M:%S")
        return (f"{movie_session_info.movie.title} {movie_session_date} "
